...
class GDA(LinearModel):
    ...
    def fit(self, x, y):
        ...
        theta_0 = (1 / 2) * miu0.T @ sigma_inv @ miu0 - (1 / 2) * miu1.T @ sigma_inv @ miu1 - np.log((1 - fai) / fai)
...
if __name__ == '__main__':
    main('PS01\data\ds1_train.csv', 'PS01\data\ds1_valid.csv', r'C:\Users\WIN10\Desktop\CS229\PS01\predict\predict_gda_dataset1.txt')
    main('PS01\data\ds2_train.csv', 'PS01\data\ds2_valid.csv', r'C:\Users\WIN10\Desktop\CS229\PS01\predict\predict_gda_dataset2.txt')