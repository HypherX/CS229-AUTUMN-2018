...
def main(train_path, eval_path, pred_path):
    ...
    util.plot(x_train, y_train, model.theta, r'C:\Users\WIN10\Desktop\CS229\PS01\image\distribution1.png')
...
if __name__ == '__main__':
    main('PS01\data\ds1_train.csv', 'PS01\data\ds1_valid.csv', r'C:\Users\WIN10\Desktop\CS229\PS01\predict\predict1.txt')